...
def frames2flows(arFrames: np.ndarray, sAlgorithm="tvl1-fast", bThirdChannel: bool = False, bShow=False, fBound: float = 20.0) -> np.ndarray:
...
def flows2file(arFlows: np.ndarray, sTargetDir: str):
...
def flow2colorimage(ar_f_Flow: np.ndarray) -> np.ndarray:
